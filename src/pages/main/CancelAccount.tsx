        ...
        <div className="min-h-screen bg-[#050505] flex items-center justify-center p-4 overflow-hidden relative">
            ...
            >
               ...
               <motion.p
                ...
                >
                    Has cancelado el proceso de verificación de tu cuenta de pagos. Para poder recibir pagos y retirar tus ganancias, debes completar la configuración de tu cuenta bancaria.
                </motion.p>
